...
import { getFinishedPieces } from "../../../../api/services/getfinishedPieces/gefinishedPieces";
...
import {
  ...
  SubmitFINPIECES,
} from "./interfaces/finishedpieces.inteface";
...
const FinishedPieces = () => {
  ...
  const onSubmit: SubmitHandler<SubmitFINPIECES> = async (params) => {
    mutate({
      ...params,
  ...
  return (
    <>
      <PageTitle pageTitle="RELATÓRIO DE PEÇAS FINALIZADAS" />
