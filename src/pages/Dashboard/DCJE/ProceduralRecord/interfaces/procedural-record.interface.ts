export interface SubmitUpdateDataProcess {
    ...
    lsArquivos?: any;
    dtInicioJuros?: string;
    dtInicioCorrecao?: string;
}

export interface SubmitUpdateDataProcessMulti {
    idProcesso: number;
    idAto: number;
    txNumeroMandadoSeguranca: string;
    txNumeroFormatado: string;
    ...
    lsFichasProcessuaisParametrosCalculo: lsFichasProcessuaisParametrosCalculoI[];
    txIndiceCorrecao?: {
        label: string;
        value: string;
    };
...
interface lsFichasProcessuaisParametrosCalculoI {
    idFichaProcessual: number;
    txIndiceCorrecao: string;
    txObservacaoCorrecao: string;
    txTipoIndiceCorrecao: string;
    dtInicioCorrecao: string;
    dtFinalCorrecao: string;
}
