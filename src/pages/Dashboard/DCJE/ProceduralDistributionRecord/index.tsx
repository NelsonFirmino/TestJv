...
const ProceduralDistributionRecord = () => {
  ...
  if (!isLoadingFichaDCJE && fichaDCJE?.status !== "OK") {
    return (
      <>
        <PageTitle
          pageTitle="FICHA DE ENCAMINHAMENTO PROCESSUAL A DCJE/PGE DE DISTRIBUIÇÂO PENDENTE"
...
export default ProceduralDistributionRecord;
