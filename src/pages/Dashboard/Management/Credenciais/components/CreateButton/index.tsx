...
import { postCredenciaisPje } from "../../../../../../api/services/credenciais-pje/credenciaisPje-Service";
import { BaseModal } from "../../../../../../components/BaseModal";
import { SharedState } from "../../../../../../context/SharedContext";
import { useTribunaisPje } from "../../../../../../hooks/useTribunaisPje";
import { SubmitEditCredentials } from "./create-credencial.interface";
...
export const CreateCredencialButton = ({ onClick, isOpen }: Edit) => {
  ...
  return (
    <>
      ...
      <S.Wrapper onClick={() => setOpenModal(true)}>Adicionar</S.Wrapper>
    </>
  );
};
