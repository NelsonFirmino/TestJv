import { CaretDown, MagnifyingGlass, XCircle } from "phosphor-react";
import Select from "react-select";
import styled from "styled-components";

export const OpenSeta = styled(CaretDown)<{
    open: boolean;
}>`
    cursor: pointer;
...
export const SelectedWrapper = styled.p`
    font-size: 1.4rem;
    padding: 1rem;
    font-weight: bold;
    border-width: 0.3rem;
    ...
    border-color: ${({ theme }) => theme.colors.jvrisAquaDark};
    color: ${({ theme }) => theme.colors.jvrisAquaDarker};
    cursor: pointer;
    transition: all 500ms;

    &:hover {
        color: ${({ theme }) => theme.colors.jvrisAqua};
        border-color: ${({ theme }) => theme.colors.jvrisAqua};
    }
`;
...
export const SubmitButton = styled.button`
    ...
    background-color: ${({ theme, disabled }) =>
        disabled ? theme.colors.grey : theme.colors.softRed};
    outline: none;
    border: none;
    text-align: center;
    width: 12rem;
    ...
    :hover {
        background-color: ${({ theme, disabled }) =>
            disabled ? theme.colors.grey : theme.colors.darkRed};
    }
`;
