...
import { Circle, Copy, CurrencyDollarSimple, Info, Shuffle } from "phosphor-react";
...
export const ContainerActType = styled(ContainerTag) <ContainerActType>`
    background-color: ${({ theme, txStatusCadastroAto }) => txStatusCadastroAto === "A" ? theme.colors.softGreen : theme.colors.softYellow};
`;
...
export const RedistributionIcon = styled(Shuffle)<ContainerRedistribution>`
    font-size: 1.8rem;
    color: ${({ isRedistribuicaoRecusada, theme }) => isRedistribuicaoRecusada ? theme.colors.softRed : theme.colors.softGreen };
`;

export const InacaoIcon = styled(ShareFat)<ContainerInacao>`
    font-size: 1.6rem;
    color: ${({ isDespachoRecusado, theme }) => isDespachoRecusado ? theme.colors.softRed : theme.colors.softGreen };
`;
...
export const ContadoriaIcon = styled(CurrencyDollarSimple) <{
    ...
    font-size: 1.8rem;
     color: ${({ theme,devolvida }) => devolvida?theme.colors.softGreen:theme.colors.softRed  };
`;
