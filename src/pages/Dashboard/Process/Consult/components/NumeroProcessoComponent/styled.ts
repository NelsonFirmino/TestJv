...
type ContadoriaIcon = {
  ...
  idRespostaFichaProcessualMaiorZero: boolean;
};
...
export const NumberProcess = styled.p`
  font-size: 1.35rem;
...
export const ContadoriaIcon = styled(CurrencyDollarSimple)<ContadoriaIcon>`
  font-size: 1.8rem;
  font-weight: bold;
  color: ${({
    theme,
    isFichaProcessualDevolvida,
