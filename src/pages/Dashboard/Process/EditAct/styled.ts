...
export const RegisterProcessLink = styled(Link)`
    display: flex;
    margin-left: auto;
    align-items: center;
    padding: 0.5rem 1rem;
...
export const ContainerAudience = styled.div`
    ...
    align-items: center;
    padding: 2rem 1rem;
    background-color: ${({ theme }) => theme.colors.softYellowLight};
    border-radius: 1rem;
    font-size: 1.2rem;
`;
...
export const RegisterActButton = styled(Link)`
    margin-left: 1rem;
    text-align: center;
    text-decoration: none;
    border-radius: 1rem;
...
export const ButtonTriagem = styled.button`
    border-radius: 1rem;
    cursor: pointer;
    outline: none;
    border: none;
    ...
    &:active {
        background-color: ${({ theme }) => theme.colors.saveGreenButtonActive};
    }
`;
