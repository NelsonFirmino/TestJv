...
import { deleteExcluirCalculo } from "../../../../../../api/services/RespostaDcje/respostaDcje";
import { BaseModal } from "../../../../../../components/BaseModal";
import { useCalculosContext } from "../../context/CalculosContext";
import * as S from "./styled";

export const ExcluirCalculo = ({ dataTable }: any) => {
  const { updateData, setUpdateData } = useCalculosContext();
  const [isOpenModal, setOpenModal] = useState(false);

  const deleteCalculoMutation = useMutation(deleteExcluirCalculo, {
      ...
      >
        <S.ContainerForm>
          ...
          <S.OptionsContainer>
            ...
            <S.OptionRemove
              onClick={() => deleteCalculoMutation.mutate(dataTable.id)}
            >
              Excluir
            </S.OptionRemove>
          </S.OptionsContainer>
