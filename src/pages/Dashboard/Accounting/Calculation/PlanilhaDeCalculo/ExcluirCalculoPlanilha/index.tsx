...
import { deleteExcluirCalculoPlanilha } from "../../../../../../api/services/RespostaDcje/respostaDcje";
...
export const ExcluirCalculoPlanilha = (props: Excluir) => {
  const { dataTable, onClick } = props;
  const { updateData, setUpdateData } = useCalculosContext();
  const [isOpenModal, setOpenModal] = useState(false);

  const deleteCalculoMutation = useMutation(deleteExcluirCalculoPlanilha, {
