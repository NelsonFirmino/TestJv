...
import { deleteCalcFinancUrv } from "../../../../../../api/services/RespostaDcje/respostaDcje";
...
export const ExcluirCalculoUrv = (props: Excluir) => {
  const { dataTable, onClick } = props;
  const { updateData, setUpdateData } = useCalculosContext();
  const [isOpenModal, setOpenModal] = useState(false);

  const deleteCalculoMutation = useMutation(deleteCalcFinancUrv, {
