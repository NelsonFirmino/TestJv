...
import { deleteExcluirCalculoFinanceiro } from "../../../../../../../api/services/RespostaDcje/respostaDcje";
...
export const ExcluirCalculoFinanceiro = (props: Excluir) => {
  const { dataTable, onClick } = props;
  const { updateData, setUpdateData } = useCalculosContext();
  const [isOpenModal, setOpenModal] = useState(false);

  const deleteCalculoMutation = useMutation(deleteExcluirCalculoFinanceiro, {
