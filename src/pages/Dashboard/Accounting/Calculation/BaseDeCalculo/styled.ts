...
export const SectionFinanceiro = styled.section`
  display: flex;
  flex-direction: column;
  width: 100%;
  padding-top: 2rem;
...
export const SectionFinanceiroEnq = styled.section`
  display: flex;
  flex-direction: column;
  width: 100%;
  padding-top: 2rem;
...
export const CustomSelectEnq = styled(Select)<CustomSelectProps>`
  width: 42rem;
  * {
    font-size: 1.3rem;
  }
...
export const CustomSelectIncidencia = styled(Select)<CustomSelectProps>`
  width: 45rem;
  * {
    font-size: 1.3rem;
  }
...
export const SectionImportarDadosErgon = styled.div`
  display: flex;
  justify-content: center;
  align-items: center;
  font-size: 1.2rem;
...
export const IncluirButton2 = styled.button`
  transition: all 500ms ease;
  cursor: ${({ disabled }) => (disabled ? "not-allowed" : "pointer")};
  background-color: ${({ theme, disabled }) =>
    disabled ? theme.colors.grey : theme.colors.jvrisAqua};
...
export const LimparButton = styled.button`
  ...
  cursor: ${({ disabled }) => (disabled ? "not-allowed" : "pointer")};
  background-color: ${({ theme, disabled }) =>
    disabled ? theme.colors.grey : theme.colors.softBlue};
  outline: none;
  border: none;
  text-align: center;
  width: 15rem;
  ...
  :hover {
    background-color: ${({ theme, disabled }) =>
      disabled ? theme.colors["gray/400"] : theme.colors.blue};
  }
`;
